...
class PatientController {
    ...
    public function bookAppointment() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!isset($_SESSION['user_id'])) {
                echo "Debes iniciar sesión para reservar una cita.";
                return;
            }
    ...
    public function bookService() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            session_start();
            if (!isset($_SESSION['user_id'])) {
                echo "Debes iniciar sesión para reservar un servicio.";
                return;
            }
            ...
            if ($stmt->execute()) {
                echo "Servicio reservado con éxito.";
            } else {
    ...
    public function cancelAppointment() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            session_start();
            if (!isset($_SESSION['user_id'])) {
                echo "Debes iniciar sesión para cancelar una cita.";
                return;
            }
    ...
    public function getSpecialtiesAndDoctors() {
