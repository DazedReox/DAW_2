...
#!perl
#line 29
    eval 'exec C:\Users\reox\Desktop\DAW_2\1Marzo\PHP\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\reox\Desktop\DAW_2\1Marzo\PHP\xampp\perl\bin\perl.exe';
